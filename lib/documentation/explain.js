...
`,
  ...
  `,
    ...
    partition: `
  Split array into two arrays: one for those elements that return
  true when passed to callback function and one for those elements
  that return false

  catalyst.partition([0, 1, 2, 3, 4, 5], (el) => el % 2 === 0 )
  [[0, 2, 4], [1, 2, 5]]
  `,
